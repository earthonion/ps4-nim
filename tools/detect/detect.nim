...
when defined(openbsd) or defined(freebsd) or defined(netbsd):
  ...
  const
    cc = "clang -isysroot /home/ac2pic/ansi-c/src/github.com/OpenOrbis/OpenOrbis-PS4-Toolchain -isystem /home/ac2pic/ansi-c/src/github.com/OpenOrbis/OpenOrbis-PS4-Toolchain/include -o $# $#.c "
    cpp = cc # "clang++ -isysroot $OO_PS4_TOOLCHAIN/ -isystem $OO_PS4_TOOLCHAIN/include/ -isystem $OO_PS4_TOOLCHAIN/include/c++/v1/ -o $# $#.c"
else:
  const
    cc = "gcc -o $# $#.c"
    cpp = "gcc -E -o $#.i $#.c"
