...
> [!NOTE]
>  This is a re-upload of the OpenOrbis-Nim/Nim project. The original repository was deleted but was licensed under the MIT license, so we are redistributing it here.
