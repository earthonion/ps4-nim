...
type
  ...
  TSystemCC* = enum
    ccNone, ccGcc, ccNintendoSwitch, ccOrbisLLVM, ccLLVM_Gcc, ccCLang, ccBcc, ccVcc,
  ...
  if conf.symbols.hasKey(symbol):
    ...
    of "posix", "unix":
      result = conf.target.targetOS in {osLinux, osMorphos, osSkyos, osIrix, osPalmos,
                            ...
                            osAndroid, osNintendoSwitch, osFreeRTOS, osCrossos, osZephyr, osOrbis, osNuttX}
    of "linux":
    ...
    of "orbis":
      result = conf.target.targetOS == osOrbis
    of "freertos", "lwip":
