...
const EBADF* = cint(9)
const EBADMSG* = cint(89)
const EBUSY* = cint(16)
const ECANCELED* = cint(85)
...
const ENOLINK* = cint(91)
const ENOMEM* = cint(12)
const ENOMSG* = cint(83)
...
const ENXIO* = cint(6)
const EOPNOTSUPP* = cint(45)
const EOVERFLOW* = cint(84)
const EPERM* = cint(1)
const EPIPE* = cint(32)
const EPROTO* = cint(92)
...
const F_GETLK* = cint(11)
const F_SETLK* = cint(12)
const F_SETLKW* = cint(13)
...
const O_DSYNC* = cint(0)
const O_NONBLOCK* = cint(4)
const O_RSYNC* = cint(0)
const O_SYNC* = cint(128)
const O_ACCMODE* = cint(3)
const O_RDONLY* = cint(0)
const O_RDWR* = cint(2)
const O_WRONLY* = cint(1)
const O_CLOEXEC* = cint(1048576)
const O_DIRECT* = cint(65536)
const O_DIRECTORY* = cint(131072)
const O_PATH* = cint(0)
const O_NOATIME* = cint(0)
const O_TMPFILE* = cint(0)
...
const FTW_F* = cint(1)
const FTW_D* = cint(2)
const FTW_DNR* = cint(3)
const FTW_DP* = cint(6)
const FTW_NS* = cint(4)
const FTW_SL* = cint(5)
const FTW_SLN* = cint(7)
...
const PTHREAD_CANCEL_ASYNCHRONOUS* = cint(2)
...
const PTHREAD_EXPLICIT_SCHED* = cint(0)
const PTHREAD_INHERIT_SCHED* = cint(4)
const PTHREAD_MUTEX_DEFAULT* = cint(1)
const PTHREAD_MUTEX_ERRORCHECK* = cint(1)
const PTHREAD_MUTEX_NORMAL* = cint(3)
